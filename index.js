...
class Performance {
  ...
  info() {
    console.log(`Гурт ${this.#band} виступить в ${this.#location} ${this.#date.toLocaleDateString()}.`);
  }
...
class guitarist extends Musician {
  constructor() {
    super();
    this.name = "Jimmy Page";
    this.instrument = "гітара";
    this.band = "Led Zeppelin";
  }
}
/*
 ...
 */
 class bassist extends Musician {
  constructor() {
    super();
    this.name = "Paul McCartney";
    this.instrument = "бас-гітара";
    this.band = "The Beatles";
  }
}
...
class SongWriter {
  constructor() {
    this.songs = ["Yesterday", "Hey Jude", "Let It Be"];
  }
}
...
class concert {
  constructor(band) {
    this.band = band;
    this.location = "BBC studios";
    this.date = new Date("1994-07-06");
